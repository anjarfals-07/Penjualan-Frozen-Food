...
//       setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
     ...
     public void tanggal(){
      ...
      private void bersihhkantable(){
          Object[]baris = {"NO","ID PENJUALAN","KODE BARANG","NAMA BARANG","HARGA","QTY","SUBTOTAL"};
     ...
     int harga = Integer.parseInt(txtharga.getText());
         ...
         txtsubtotal.setText(new String().valueOf(total));
}
 
     public void Total(){
         int total = 0;
         for (int i = 0; i < tbkirim.getRowCount(); i++) {
             int ammount = Integer.parseInt(String.valueOf(tbkirim.getValueAt(i, 6)));
             total += ammount;
     ...
     public void matikantextcs(){
        ...
        public void simpantable(){
         ...
         int stok =1;
          if("".equals(txtnamacs.getText())|"".equals(txtjumlah.getText())|txtjumlah.getText().isEmpty()==true ){
    ...
    private void initComponents() {
        ...
        lbidpetugas = new javax.swing.JLabel();
        ...
        lbidpetugas.setText("jLabel1");

        lbnamapetugas.setText("jLabel1");
        ...
        jPanel6.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 139, 380, 168));
        ...
        jPanel5.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 110, 25));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtsubtotal, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
                            .addComponent(txtjumlah))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel1)
                        .addGap(18, 18, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btambah1, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(bkurang, javax.swing.GroupLayout.Alignment.TRAILING))))
        ...
        jPanel6.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(396, 46, -1, 260));
        ...
        btambah2.setBackground(new java.awt.Color(0, 0, 204));
        ...
        jPanel6.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 920, 148));
        ...
        btambah.setText("Tambah Data Penjualan");
    ...
    private void bkurangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bkurangActionPerformed
        ...
        if(row!= -1){
            ...
            String sql = "DELETE FROM isi_penjualan where id='"+nomer+"'";
            String resetno="ALTER TABLE isi_penjualan DROP `id`;";
            String consecutivenumber="ALTER TABLE isi_penjualan ADD `id` INT(11) NOT NULL AUTO_INCREMENT FIRST ,ADD PRIMARY KEY(`id`);";
            ...
            try {
                ...
                control.tampilurutanNoNota();
                control.tampilurutanPelanggan();
                control.isiTablePenjualan();
                sorter();
                Total();
                resetbarang();
    ...
    private void tbkirimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbkirimMouseClicked
        ...
        Object subtotal = (Object) tbkirim.getValueAt(i, 6);
    ...
    private void btambah2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambah2ActionPerformed
        // TODO add your handling code here:
        control.simpan_penjualan();
       control.simpanpelanggan();
       control.cetaknota();
       control.reset();
       control.awal();
     control.tampilurutanNoNota();
    ...
    private javax.swing.JLabel lbidpetugas;
...
public JLabel getTxtIdPetugas(){
 ...
 public JLabel getTxtNamaPetugas(){
        return lbnamapetugas;
    }   

    
    public JTable getTablPenjualan(){
        return tbkirim;
    }
