...
public class BackupData extends javax.swing.JFrame {
    ...
    public BackupData() {
        initComponents();
        ImageIcon icon = new ImageIcon(getClass().getResource("/icon/database.png"));
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/database.png"))); // NOI18N
        ...
        btnCariBackup.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnCariBackup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/search-icon.png"))); // NOI18N
        ...
        btnBackup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-database-backup-25.png"))); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(txtLokasiBackup, javax.swing.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtLokasiBackup, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.addTab("Backup Database", new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-database-backup-25.png")), jPanel3); // NOI18N
        ...
        btnCariRestore.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnCariRestore.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/search-icon.png"))); // NOI18N
        ...
        btnRestore.setBackground(new java.awt.Color(255, 204, 0));
        btnRestore.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnRestore.setForeground(new java.awt.Color(255, 255, 255));
        btnRestore.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-database-restore-25.png"))); // NOI18N
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(txtLokasiRestore, javax.swing.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, 0)
                        .addComponent(txtLokasiRestore, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 12, Short.MAX_VALUE)
                .addComponent(btnRestore)
                .addContainerGap())
        );

        jTabbedPane1.addTab("Restore Database", new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-database-restore-25.png")), jPanel4); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 172, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(467, 272));
    ...
    private void btnBackupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackupActionPerformed
        // TODO add your handling code here:
         try{
             String dbname = "frozen_food";
                String dbuser = "root";
            if(txtLokasiBackup.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "Pilih lokasi backup terlebih dahulu");
            } else{
             //   Process menjalankancmd = Runtime.getRuntime().exec("C:/xampp/mysql/bin/mysqldump  -uroot presensi_guru -r "+txtLokasiBackup.getText());
                  Process menjalankancmd = Runtime.getRuntime().exec("C:/xampp/mysql/bin/mysqldump  -u" + dbuser + " --database " + dbname + " -r " +txtLokasiBackup.getText());
